...
export PEER0_ORG1_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org1.solulab.com/peers/peer0.org1.solulab.com/tls/ca.crt
export PEER0_ORG2_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org2.optimize.com/peers/peer0.org2.optimize.com/tls/ca.crt
...
presetup() {
    ...
    pushd ../Chaincode/asset-transfer-ledger-queries/chaincode-go
...
VERSION="1"
CC_SRC_PATH="../Chaincode/asset-transfer-ledger-queries/chaincode-go"
