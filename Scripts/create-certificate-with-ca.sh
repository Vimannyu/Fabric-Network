createcertificatesForOrg1() {
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.org1.solulab.com -M ${PWD}/crypto-config-ca/peerOrganizations/org1.example.com/peers/peer0.org1.solulab.com/msp --csr.hosts peer0.org1.solulab.com --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
